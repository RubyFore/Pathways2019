#!/bin/bash
#SBATCH -J VCUnequalSetsVaryPercentCausal1024SmallSet256
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCUnequalSetsVaryPercentCausal1024SmallSet256RR1.15.RData')
