...
date
echo ""
R --no-save > ~/Pathways2019/Simulations/OutputTxtFiles/VCHalfCausalReplicationTest.txt 2>&1 << EOF
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCHalfCausalReplicationTest.csv')
