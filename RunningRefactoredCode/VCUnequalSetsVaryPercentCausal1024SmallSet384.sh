#!/bin/bash
#SBATCH -J VCUnequalSetsVaryPercentCausal1024SmallSet384
...
# adjusting the percent causal in unequal set sizes, 3/8 vs 5/8
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCUnequalSetsVaryPercentCausal1024SmallSet384RR1.15.RData')
