#!/bin/bash
#SBATCH -J VCEqualSets1024CausalIn1Eighth
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ruby_fore@alumni.brown.edu
date
echo ""
R --no-save > ~/Pathways2019/Simulations/OutputTxtFiles/VCEqualSets1024CausalIn1Eighth.txt 2>&1 << EOF
source('~/Pathways2019/RunningRefactoredCode/runSimsBeaker.R')

# risk ratio or vector of risk ratios
rr_var <- list(c(rep(1.15, 128),rep(1, 896)))
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCEqualSets1024RR1.15CausalIn1Eighth.RData')
