...
rr_var <- list(c(rep(1,896), rep(1.1, 128)), 
               c(rep(1.1,16), rep(1, 112),  rep(1,784),rep(1.1, 112)),
               c(rep(1.1, 32), rep(1,96), rep(1,800), rep(1.1, 96)), 
               c(rep(1.1,48), rep(1,80), rep(1,816), rep(1.1, 80)), 
               c(rep(1.1, 80), rep(1,48), rep(1,848), rep(1.1, 48)), 
               c(rep(1.1, 128), rep(1, 896)))
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCUnequalSetsVaryPercentCausal1024.RData')
