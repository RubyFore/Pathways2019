#!/bin/bash
#SBATCH -J VCHalfCausal1024
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ruby_fore@alumni.brown.edu
date
echo ""
R --no-save > ~/Pathways2019/Simulations/OutputTxtFiles/VCHalfCausal1024.txt 2>&1 << EOF
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCHalfCausal1024.csv')
