#!/bin/bash
#SBATCH -J VCEqualSets1024OneQuarter
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ruby.a.fore@gmail.com
date
echo ""
R --no-save > ~/Pathways2019/Simulations/OutputTxtFiles/VCEqualSets1024OneQuarter.txt 2>&1 << EOF
source('~/Pathways2019/RunningRefactoredCode/runSimsBeaker.R')

# risk ratio or vector of risk ratios
rr_var <- list(c(rep(c(1,1.15), 128), rep(1, 768)))
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/VCEqualSets1024RR1.15CausalInOneQuarter.RData')
