#!/bin/bash
#SBATCH -J BurdenOneVariantReplicationTest
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ruby_fore@alumni.brown.edu
date
echo ""
R --no-save > ~/Pathways2019/Simulations/OutputTxtFiles/BurdenOneVariantReplicationTest.txt 2>&1 << EOF
...
writePowerDFToFile('~/Pathways2019/Simulations/PowerDFs/BurdenOneVariantReplicationTest.csv')
