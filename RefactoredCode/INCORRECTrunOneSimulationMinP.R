runOneSimulationMinP <- function(paramList){
  ...
  testStatsNew <- calculateStageOneVCTestOnPerms(MLElist[[1]], MLElist[[2]], numPerms, setSize, numTests)
  ...
  return( INCORRECTfindStage2PvalfromPvals(truePvals, permPvals, min))
}
